        ...
        public static void Draw()
        {
            ...
            for (int i = 0; i < sortedList.Count; i++)
            {
                ...
                if (sortedList[i].pastOpponents.Count < battleCounter)
                {
                    ...
                    {
                        //Sprawdzany gracz ma pustą listę przeciwników, bo pauzował
                        //if((sortedList[j].pastOpponents.Count == 0 && sortedList[j].hasPaused == true) || (sortedList[i].pastOpponents.Count == 0 && sortedList[i].hasPaused == true))
                        //{
